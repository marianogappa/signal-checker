...
func TestValidate(t *testing.T) {
	...
	tss := []test{
		{
			name: "entries does not contain a range",
			input: common.SignalCheckInput{
				BaseAsset:              "BTC",
				QuoteAsset:             "USDT",
				Entries:                []common.JsonFloat64{f(2.0)}, // must have either zero or two or more floats
				StopLoss:               f(0.1),
			...
			expectedErr: common.ErrInvalidEntriesLength,
		},
		{
			...
			input: common.SignalCheckInput{
				BaseAsset:              "BTC",
				QuoteAsset:             "USDT",
				Entries:                []common.JsonFloat64{f(3.0), f(2.0)},
